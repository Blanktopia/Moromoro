...
package me.weiwen.moromoro.actions.enchantment
...
data class ToggleEnchantment(val enchantment: Enchantment, val level: Int, val name: String, val toggled: Boolean? = null) :
    Action {
