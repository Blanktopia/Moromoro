...
data class GrappleTick(val acceleration: Double = 0.5, @SerialName("max-speed") val maxSpeed: Double = 1.0, val range: Double = 50.0, val particle: Particle = Particle.ELECTRIC_SPARK) : Action {
